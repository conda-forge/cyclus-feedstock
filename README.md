...
Home: https://fuelcycle.org/

Package license: BSD-3-Clause

Summary: The agent-based fuel cycle simulator.

Development: http://github.com/cyclus/cyclus
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cyclus-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cyclus-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `cyclus` available on your platform:
...
```
pixi search cyclus --channel conda-forge
```
